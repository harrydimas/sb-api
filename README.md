...
```
java -Dspring.profiles.active=production -jar ./target/sb-api-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=dev.sb/s-b-api
```
